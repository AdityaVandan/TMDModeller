...
Alter table project add width Int NOT NULL default 1000;
Alter table project add height Int NOT NULL default 800;
Alter table database_table add xCoor Int NOT NULL;
Alter table database_table add yCoor Int NOT NULL;
